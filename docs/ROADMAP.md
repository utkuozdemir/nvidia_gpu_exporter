...
- Make the container image run as a non-root user by default ([#463](https://github.com/utkuozdemir/nvidia_gpu_exporter/issues/463)). Needs a verification session on GPU hardware first.
